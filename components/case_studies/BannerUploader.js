...
// components/cms/BannerUploader.js
import { useRef } from "react";

export default function BannerUploader({ preview, onChange }) {
    ...
    return (
        <div>
            ...
            <p className="text-[10px] text-gray-700 mt-1.5">
                {/* Will upload to: firebase storage → banners/{id} */}
                Image will be stored in Firebase Storage under <code className="text-gray-600">banners/</code>
            </p>
        </div>
    );
}